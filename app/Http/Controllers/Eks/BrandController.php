...
class BrandController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(BrandRequest $oRequest)
    {
        try {
            $this->rBrand->createBrand($oRequest);
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(BrandRequest $oRequest, $id)
    {
        try {
            ...
            $family = $this->rBrand->updateBrand($id, $oRequest);
