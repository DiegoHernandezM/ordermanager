                                            ...
                                            <tr>
                                                <td align="center">
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                                        <tr>
                                                            <td align="center">
                                                                <a href="http://ordermanager.test/api/validtoken/{{ $body[1] }}" class="f-fallback button button--green" target="_blank">Resetea tu contraseña</a>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                        ...
                                        <table class="body-sub" role="presentation">
                                            <tr>
                                                <td>
                                                    ...
                                                    <p class="f-fallback sub">http://ordermanager.test/api/validtoken/{{ $body[1] }}</p>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
